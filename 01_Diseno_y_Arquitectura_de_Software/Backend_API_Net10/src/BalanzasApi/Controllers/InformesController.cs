...
{
    private readonly IInformeRepository _repo;
    public InformesController(IInformeRepository repo) => _repo = repo;
    ...
    [HttpPost]
    public async Task<IActionResult> Crear([FromBody] Informe entidad)
    {
    ...
    [HttpPut("{id:int}")]
    public async Task<IActionResult> Actualizar(int id, [FromBody] Informe entidad)
    {
        entidad.Id = id;
