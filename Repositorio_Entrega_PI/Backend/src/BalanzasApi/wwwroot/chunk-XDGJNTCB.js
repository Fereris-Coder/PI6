import{Ba as A,Ea as P,j as Q,l as E,n as N,r as O,ya as q,za as g}from"./chunk-WPIB7CS7.js";import{$a as $,Bb as l,Cb as D,Db as F,Eb as f,Gb as m,Hb as y,Lb as j,Ma as o,Mb as S,P as v,Q as h,Sb as z,V as T,Xa as b,Ya as C,bb as r,da as p,ib as i,lb as k,lc as B,mb as I,qb as u,rb as d,sb as x,tb as M,ub as w}from"./chunk-7QMJEFD7.js";var V=["icon"],H=["*"];function G(e,c){if(e&1&&x(0,"span",4),e&2){let t=l(2);i("ngClass",t.icon)}}function J(e,c){if(e&1&&(M(0),r(1,G,1,1,"span",3),w()),e&2){let t=l();o(),i("ngIf",t.icon)}}function K(e,c){}function L(e,c){e&1&&r(0,K,0,0,"ng-template")}function U(e,c){if(e&1&&(u(0,"span",5),r(1,L,1,0,null,6),d()),e&2){let t=l();o(),i("ngTemplateOutlet",t.iconTemplate||t._iconTemplate)}}var W=({dt:e})=>`
.p-tag {
    display: inline-flex;
    align-items: center;
